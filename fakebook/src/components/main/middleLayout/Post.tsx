...
export default function Post({ name, avatar, timeStamp, privacy, status, imgUrl, likes, comments, shares} : TsinglePostInfo) {
    ...
    const formattedTime = new Date(timeStamp).getMinutes() + ' minutes ago';
  ...
  return (
        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                    ...
                    <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
                        ...
                        <div className="_feed_inner_timeline_total_reacts_txt">
                            <p className="_feed_inner_timeline_total_reacts_para1">
                                <a href="#0"><span>{comments||0}</span> Comment</a>
                            </p>
                    ...
                    <div className={`_timline_comment_main${comments?' ': ' d-none'}`}>
