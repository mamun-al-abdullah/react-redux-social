                ...
                <div className="_feed_inner_timeline_post_top">
                    <div className="_feed_inner_timeline_post_box">
                        ...
                        <div className="_feed_inner_timeline_post_box_txt">
                            ...
                            <p className="_feed_inner_timeline_post_box_para">{formattedTime} . 
                                <a href="#0">{privacy}</a>
                            </p>
                        </div>
                    </div>
                    <div className="_feed_inner_timeline_post_box_dropdown">
                        <div className="_feed_timeline_post_dropdown">
                            ...
                            <a href="#0" id="_timeline_show_drop_btn" className="_feed_timeline_post_dropdown_link">
            ...
            <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
                ...
                <div className="_feed_inner_timeline_total_reacts_txt">
                    <p className="_feed_inner_timeline_total_reacts_para1">
                        <a href="#0"><span>{commentsArr.length}</span> Comment</a>
                    </p>
                    <p className="_feed_inner_timeline_total_reacts_para2"><span>{shares||0}</span> Share</p>
                </div>
            </div>
                ...
                <div className="_comment_main">
                    <div className="_comment_image">
                        <a href="profile.html" className="_comment_image_link">
                            <img src={lastComment.avatar} alt="" className="_comment_img1"/>
                        </a>
                    </div>
                        ...
                        <div className="_comment_details">
                            <div className="_comment_details_top">
                                <div className="_comment_name">
                                    <a href="profile.html ">
                                        <h4 className="_comment_name_title">{lastComment.name}</h4>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="_comment_reply">
                                <div className="_comment_reply_num">
                                    <ul className="_comment_reply_list">
                                        ...
                                        <li><span className="_time_link">.{getTimeElapsed(new Date(lastComment.timeStamp))}</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
